...
1. [Spring Boot Maven Plugin Reference Guide](https://docs.spring.io/spring-boot/docs/2.5.5/maven-plugin/reference/html/)
1. [Spring Web](https://docs.spring.io/spring-boot/docs/2.5.5/reference/htmlsingle/#boot-features-developing-web-applications)
1. [JDBC API](https://docs.spring.io/spring-boot/docs/2.5.5/reference/htmlsingle/#boot-features-sql)
